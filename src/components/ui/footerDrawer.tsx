              ...
              <div className="px-4">
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground" tabIndex={0} data-vaul-no-drag="true">
                    Responses are AI generated by <code>gemini-3.1-flash-lite-preview</code>. They are intended as historically informed interpretations and do not represent the actual words or personal views of the composers.
                    </p>
                  </div>
                  <div className="space-y-1">
                    <div className="relative py-2">
