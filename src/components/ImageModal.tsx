  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="p-1 rounded-full transition-colors duration-200 hover:bg-muted-foreground/25 group-hover:bg-muted-foreground/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
